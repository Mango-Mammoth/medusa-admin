...
const SettingsCard: React.FC<SettingsCardProps> = ({
  ...
  return (
    <Link to={to} className="flex items-center flex-1">
      ...
      >
        <div className="h-2xlarge w-2xlarge bg-blue-100 rounded-circle flex justify-center items-center text-blue-20 group-disabled:bg-grey-10 group-disabled:text-grey-40">
          {icon}
        </div>
